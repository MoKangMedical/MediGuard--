...
MediGuard_医保智盾 - Medical AI Project
...
1. **克隆仓库**
```bash
git clone https://github.com/MoKangMedical/MediGuard--.git
cd MediGuard--
```
...
2. **运行容器**
```bash
docker run -d -p 8000:8000 --name MediGuard-- MediGuard--
```
...
- **项目主页**: https://github.com/MoKangMedical/MediGuard--
- **问题反馈**: https://github.com/MoKangMedical/MediGuard--/issues
